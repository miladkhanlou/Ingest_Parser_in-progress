...
#Source of truth to find misspellings and typos for LDL content (at the final stage we are gpoing to read from txt file instead of copy and pasting the Tags and Attributes):
